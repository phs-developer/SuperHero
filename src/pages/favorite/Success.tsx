...
import { HeroDataType } from "../../commons/types/hero";
                ...
                <Article>
                    ...
                    <Stats>
                        {stats.map((title, i) => {
                            ...
                            return (
                                <button
                                    className={`stats ${onDetail === i && "active"}`}
                                    type="button"
                                    name={title}
                                    onClick={() => setOnDetail(i)}
                                >
                                    {upperTitle}
                                </button>
                            );
                ...
                return (
                    <StatsBody className={detail === idx ? "active" : ""}>
                        {category.map((title) => {
                            ...
                            return (
                                <li key={title}>
                                    <img src={color[idx]} alt="icon" />
                                    {title}
                                    <span>{data[categoryString][smallTitle]}</span>
                                </li>
                            );
                        })}
                    </StatsBody>
